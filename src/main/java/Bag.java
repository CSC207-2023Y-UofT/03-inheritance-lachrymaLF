...
public abstract class Bag {
     ...
     * its contents.)
     */
    public Bag(String col, int capacity) {
        this.color = col;
    ...
    public String popItem() {
        if (this.numberOfContents == 0)
            ...
            this.numberOfContents--;
            String t = this.contents[this.numberOfContents];
    ...
    public void increaseCapacity(int n) {
        ...
        this.capacity += n;
        String[] nt = new String[this.capacity];
        System.arraycopy(this.contents, 0, nt, 0, this.contents.length);
        this.contents = nt;
    }
